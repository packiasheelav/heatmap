export const processData = ({ heatData }) => {
    ...
    const sl4 = sortData.slice(splitPositionL3, total)
    let l1endRange = 0
    let l2endRange = 0
    let l3endRange = 0
    let l4endRange = 0
    ...
    if (sl4.length > 0) l4endRange = sl4[sl4.length - 1].count
    ...
    return { day0HeatEntry, day1HeatEntry, day2HeatEntry, day3HeatEntry, day4HeatEntry, day5HeatEntry, day6HeatEntry }
}